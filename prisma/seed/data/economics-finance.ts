...
export const economicsFinance: DomainSeed = {
  ...
  paths: [
    {
      slug: "economist",
      name: "Economist",
      tagline: "Analyze markets and policy",
      description:
        "Path from micro/macro foundations through econometrics to policy analysis.",
      level: "BEGINNER",
      estimatedMonths: 16,
      phases: [
        {
    ...
    },
    {
      ...
      tagline: "Corporate finance and investment mastery",
      description:
        "Practical finance: valuation, portfolio management, and risk.",
      level: "BEGINNER",
      estimatedMonths: 12,
      phases: [
        {
    ...
    },
    {
      slug: "quant-finance",
      name: "Quantitative Finance",
      tagline: "Math meets markets",
      description:
        "High-level quantitative finance combining math, programming, and finance.",
      level: "ADVANCED",
      estimatedMonths: 20,
      phases: [
        {
  ...
  courses: [
    {
      slug: "harvard-econ-10",
      title: "Principles of Economics",
      universitySlug: "harvard",
      subjectSlug: "microeconomics",
      level: "BEGINNER",
      description:
        "Harvard's introductory economics course covering micro and macro fundamentals.",
      url: "https://www.extension.harvard.edu/",
      skillSlugs: [
        "supply-and-demand",
        "market-equilibrium",
    ...
    },
    {
      ...
      level: "BEGINNER",
      description:
        "MIT's foundational microeconomics course.",
      url: "https://ocw.mit.edu/courses/14-01-principles-of-microeconomics-fall-2018/",
      skillSlugs: [
        "supply-and-demand",
        "market-equilibrium",
    ...
    },
    {
      ...
      level: "BEGINNER",
      description:
        "MIT's foundational macroeconomics course.",
      url: "https://ocw.mit.edu/courses/14-02-principles-of-macroeconomics-fall-2023/",
      skillSlugs: [
        "gdp-growth",
        "inflation",
    ...
    },
    {
      ...
      level: "INTERMEDIATE",
      description:
        "MIT's intermediate microeconomics course.",
      url: "https://ocw.mit.edu/courses/14-04-intermediate-microeconomic-theory-fall-2020/",
      skillSlugs: [
        "consumer-theory",
        "producer-theory",
    ...
    {
      slug: "mit-14-05-intermediate-macro",
      title: "Intermediate Macroeconomics",
      universitySlug: "mit",
      subjectSlug: "macroeconomics",
      code: "14.05",
      level: "INTERMEDIATE",
      description:
        "MIT's intermediate macroeconomics course.",
      url: "https://ocw.mit.edu/courses/14-05-intermediate-macroeconomics-spring-2013/",
      skillSlugs: [
        "keynesian-economics",
        "business-cycles",
    ...
    {
      slug: "mit-14-32-econometrics",
      title: "Econometrics",
      universitySlug: "mit",
      subjectSlug: "econometrics",
      code: "14.32",
      level: "INTERMEDIATE",
      description:
        "MIT's introductory econometrics course.",
      url: "https://ocw.mit.edu/courses/14-32-econometrics-spring-2007/",
      skillSlugs: [
        "linear-regression",
        "multiple-regression",
    ...
    },
    {
      ...
      level: "INTERMEDIATE",
      description:
        "Yale's game theory course by Ben Polak.",
      url: "https://oyc.yale.edu/economics/econ-159",
      skillSlugs: ["game-theory"],
    },
    {
      slug: "yale-econ-252",
      ...
      level: "INTERMEDIATE",
      description:
        "Yale's financial markets course by Robert Shiller.",
      url: "https://oyc.yale.edu/economics/econ-252",
      skillSlugs: [
        "financial-markets",
        "behavioral-finance",
    ...
    {
      slug: "mit-15-401-finance",
      title: "Finance Theory I",
      universitySlug: "mit",
      subjectSlug: "corporate-finance",
      code: "15.401",
      level: "BEGINNER",
      description:
        "MIT's foundational finance course.",
      url: "https://ocw.mit.edu/courses/15-401-finance-theory-i-fall-2008/",
      skillSlugs: [
        "time-value-of-money",
        "capital-budgeting",
    ...
    {
      slug: "mit-15-433-investments",
      title: "Investments",
      universitySlug: "mit",
      subjectSlug: "investments",
      code: "15.433",
      level: "INTERMEDIATE",
      description:
        "MIT's investments course.",
      url: "https://ocw.mit.edu/courses/15-433-investments-spring-2003/",
      skillSlugs: [
        "portfolio-theory",
        "asset-pricing",
    ...
    {
      slug: "harvard-fin-modeling",
      title: "Financial Modeling for Valuation",
      universitySlug: "harvard",
      subjectSlug: "corporate-finance",
      level: "INTERMEDIATE",
      description:
        "Harvard course on building financial models.",
      url: "https://www.extension.harvard.edu/",
      skillSlugs: [
        "financial-modeling",
        "financial-statements",
    ...
    {
      slug: "mit-15-450-analytics",
      title: "Analytics of Finance",
      universitySlug: "mit",
      subjectSlug: "data-skills-finance",
      code: "15.450",
      level: "ADVANCED",
      description:
        "MIT's quantitative finance course.",
      url: "https://ocw.mit.edu/courses/15-450-analytics-of-finance-fall-2010/",
      skillSlugs: [
        "quantitative-finance",
        "time-series-analysis",
  ...
  curricula: [
    {
      degreeSlug: "harvard-economics-ab",
      degreeName: "A.B. in Economics",
      degreeLevel: "BACHELOR",
      universitySlug: "harvard",
      name: "Harvard Economics AB",
      sourceUrl: "https://www.econ.harvard.edu/",
      courses: [
        {
          courseSlug: "harvard-econ-10",
          year: 1,
          semester: 1,
          order: 1,
        },
        {
          courseSlug: "harvard-econ-11",
          year: 1,
          semester: 2,
          order: 2,
        },
        {
          courseSlug: "harvard-math-1a",
          year: 1,
          semester: 1,
          order: 3,
        },
        {
          courseSlug: "harvard-econ-1010",
          year: 2,
          semester: 1,
          order: 4,
        },
        {
          courseSlug: "harvard-econ-1011",
          year: 2,
          semester: 2,
          order: 5,
        },
        {
          courseSlug: "harvard-econ-1123",
          year: 3,
          semester: 1,
          order: 6,
        },
        {
          courseSlug: "harvard-econ-1126",
          year: 3,
          semester: 1,
          order: 7,
        },
        {
          courseSlug: "harvard-econ-1120",
          year: 3,
          semester: 2,
          order: 8,
        },
        {
          courseSlug: "harvard-econ-1125",
          year: 3,
          semester: 2,
          order: 9,
        },
        {
          courseSlug: "harvard-econ-99",
          year: 4,
          semester: 1,
          order: 10,
        },
    ...
    {
      degreeSlug: "mit-economics-sb",
      degreeName: "S.B. in Economics (14-1)",
      degreeLevel: "BACHELOR",
      universitySlug: "mit",
      name: "MIT Economics SB (14-1)",
      sourceUrl: "https://economics.mit.edu/",
      courses: [
        {
          courseSlug: "mit-14-01-principles",
          year: 1,
          semester: 1,
          order: 1,
        },
        {
          courseSlug: "mit-14-02-principles",
          year: 1,
          semester: 2,
          order: 2,
        },
        {
          courseSlug: "mit-18-01-calculus",
          year: 1,
          semester: 1,
          order: 3,
        },
        {
          courseSlug: "mit-14-04-intermediate",
          year: 2,
          semester: 1,
          order: 4,
        },
        {
          courseSlug: "mit-14-05-intermediate-macro",
          year: 2,
          semester: 1,
          order: 5,
        },
        {
          courseSlug: "mit-14-32-econometrics",
          year: 2,
          semester: 2,
          order: 6,
        },
        {
          courseSlug: "mit-14-20",
          year: 3,
          semester: 1,
          order: 7,
        },
        {
          courseSlug: "mit-14-23",
          year: 3,
          semester: 1,
          order: 8,
        },
        {
          courseSlug: "mit-14-27",
          year: 3,
          semester: 2,
          order: 9,
        },
        {
          courseSlug: "mit-14-382",
          year: 3,
          semester: 2,
          order: 10,
        },
        {
          courseSlug: "mit-14-471",
          year: 4,
          semester: 1,
          order: 11,
        },
