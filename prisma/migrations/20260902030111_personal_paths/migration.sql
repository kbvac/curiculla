...
CREATE TABLE "new_LearningPath" (
    ...
    CONSTRAINT "LearningPath_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_LearningPath" ("description", "domainId", "estimatedMonths", "id", "level", "name", "order", "slug", "tagline") SELECT "description", "domainId", "estimatedMonths", "id", "level", "name", "order", "slug", "tagline" FROM "LearningPath";
